...
{
    public partial class mig_firstDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerAccoutProcesses",
                columns: table => new
                {
                    CustomerAccoutProcessID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAccoutProcesses", x => x.CustomerAccoutProcessID);
                });
